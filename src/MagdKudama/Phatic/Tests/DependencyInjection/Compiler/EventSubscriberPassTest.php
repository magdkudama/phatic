...
class EventSubscriberPassTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->pass = new EventSubscriberPass();
    ...
    public function testImplementingClassWorks()
    {
        ...
        $def = new Definition();
        $def->setClass('MagdKudama\Phatic\Tests\DependencyInjection\Compiler\Fixtures\EventSubscriberExtension');
